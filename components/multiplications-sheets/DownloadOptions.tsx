...
export const DownloadOptions: React.FC<DownloadOptionsProps> = ({ selectedTables, selectedTemplate }) => {
  ...
  const generateImages = async (): Promise<HTMLCanvasElement[]> => {
    ...
    const elements = document.querySelectorAll('.multiplication-card')
