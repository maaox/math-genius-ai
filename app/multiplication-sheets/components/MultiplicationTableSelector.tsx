...
export const MultiplicationTableSelector: React.FC<MultiplicationTableSelectorProps> = ({
  ...
  return (
    <Card className="flex flex-col mb-8 bg-white rounded-lg shadow-md h-[350px]">
      <CardHeader>
        <CardTitle className="text-2xl font-semibold text-blue-600">Selección de Tablas</CardTitle>
      </CardHeader>
