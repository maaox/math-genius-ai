...
export const TemplateGallery: React.FC<TemplateGalleryProps> = ({ selectedTemplate, onSelectTemplate }) => {
  ...
  return (
    <Card className="mb-8 bg-white rounded-lg shadow-md h-[470px]">
      <CardHeader>
        <CardTitle className="text-2xl font-semibold text-blue-600">Selecciona una plantilla</CardTitle>
      </CardHeader>
      ...
      <CardContent>
        ...
        <RadioGroup value={selectedTemplate} onValueChange={onSelectTemplate}>
          <ScrollArea className="max-h-[300px] overflow-y-auto rounded-md border">
